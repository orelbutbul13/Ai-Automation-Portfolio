...
End-to-end AI automation system that analyzes customer feedback and generates brand-aligned email responses using AI and workflow automation tools.
...
✔ Extracting key points from open-text feedback  
...
2. **AI (Google Gemini / OpenAI)** – analyzes text for sentiment and intent  
...
- **Prompt Engineering** – controlled tone & style  
...
2. AI processes the feedback text  
3. System extracts sentiment & customer intent  
4. AI generates a high-quality email reply  
...
- Significantly faster customer responses  
- Scalable for high feedback volume  
- Demonstrated reliable AI workflow orchestration  
...
(📌 *Add 2–3 screenshots of the Make scenario, response output, or workflow logic here*)
